...
timeframe of the year (select days in winter).
...
\`\`\` Observations include: July has higher maximum temperatures, on
average, than January. Temperatures seem to fluctuate in cycles. 1994
appears to have been a particularly cold winter. January temperatures
seem to fluctuate more than those in July.
